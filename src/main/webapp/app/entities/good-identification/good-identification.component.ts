...
@Component({
  selector: 'jhi-good-identification',
  templateUrl: './good-identification.component.html',
})
export class GoodIdentificationComponent extends AbstractEntityComponent<IGoodIdentification> {
  ...
  constructor(
    ...
    this.parentRoute = '/good-identification';
  ...
  trackId(index: number, item: IGoodIdentification) {
    return item.id;
  }

  get goodIdentifications() {
    return this.items;
  }

  set goodIdentifications(goodIdentification: IGoodIdentification[]) {
    this.items = goodIdentification;
  }
