...
export class PartyRoleComponent extends AbstractEntityComponent<IPartyRole> {
  constructor(
  ...
  trackId(index: number, item: IPartyRole) {
    return item.id;
  }
  ...
  set partyRoles(partyRole: IPartyRole[]) {
    this.items = partyRole;
  }
}
