...
@Component({
  selector: 'jhi-role-vendor',
  templateUrl: './role-vendor.component.html',
})
export class RoleVendorComponent extends AbstractEntityComponent<IRoleVendor> {
  constructor(
  ...
  trackId(index: number, item: IRoleVendor) {
    return item.id;
  }
  ...
  set roleVendors(roleVendor: IRoleVendor[]) {
    this.items = roleVendor;
  }
}
