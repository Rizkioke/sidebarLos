...
export class ProductUpdateComponent extends AbstractEntityUpdateComponent<IProduct> {
  ...
  constructor(
    ...
    super(dataUtils, productService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'productListModification';
  }

  protected initialState(): any {
    return { item: new Product(), tasks: [], id: undefined };
  }
