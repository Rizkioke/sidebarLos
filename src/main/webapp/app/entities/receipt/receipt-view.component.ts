...
@Component({
  selector: 'jhi-receipt-view',
  templateUrl: './receipt-view.component.html',
})
export class ReceiptViewComponent extends AbstractEntityBaseViewComponent<IReceipt> implements OnChanges {
  @Input() id: number;
  ...
  constructor(
    ...
    super(receiptService, messageService, elementRef, dataUtils, account, eventManager);
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['id']) {
      ...
      if (this.id) {
        this.item = new Receipt();
        this.receiptService.find(this.id).subscribe(result => {
