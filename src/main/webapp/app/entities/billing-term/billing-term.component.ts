...
@Component({
  selector: 'jhi-billing-term',
  templateUrl: './billing-term.component.html',
})
export class BillingTermComponent extends AbstractEntityComponent<IBillingTerm> {
  constructor(
