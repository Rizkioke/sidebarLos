...
export class PartyTypeUpdateComponent extends AbstractEntityUpdateComponent<IPartyType> {
  ...
  constructor(
    ...
    super(dataUtils, partyTypeService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'partyTypeListModification';
  }

  protected initialState(): any {
    return { item: new PartyType(), tasks: [], id: undefined };
  }
