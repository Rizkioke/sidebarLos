...
export class PeriodComponent extends AbstractEntityComponent<IPeriod> {
  ...
  constructor(
    ...
    super(periodService, parseLinks, accountService, activatedRoute, dataUtils, router, eventManager, messageService, confirmationService);

    this.parentRoute = '/period';
