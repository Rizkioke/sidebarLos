...
export class PeriodTypeComponent extends AbstractEntityComponent<IPeriodType> {
  constructor(
  ...
  set periodTypes(periodType: IPeriodType[]) {
    this.items = periodType;
  }
}
