import { Billing, IBilling } from '../billing/billing.model';
...
export interface IFinancingRequest extends IBilling {
  id?: number;
...
export class FinancingRequest implements IFinancingRequest {
  constructor(
    public id?: number,
