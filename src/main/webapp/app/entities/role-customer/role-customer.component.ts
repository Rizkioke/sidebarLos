...
@Component({
  selector: 'jhi-role-customer',
  templateUrl: './role-customer.component.html',
})
export class RoleCustomerComponent extends AbstractEntityComponent<IRoleCustomer> {
  ...
  constructor(
    ...
    this.parentRoute = '/role-customer';
  ...
  trackId(index: number, item: IRoleCustomer) {
    return item.id;
  }
  ...
  set roleCustomers(roleCustomer: IRoleCustomer[]) {
    this.items = roleCustomer;
  }
