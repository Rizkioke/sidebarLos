...
@Component({
  selector: 'jhi-term-type-update',
  templateUrl: './term-type-update.component.html',
})
export class TermTypeUpdateComponent extends AbstractEntityUpdateComponent<ITermType> {
  termtypes: ITermType[] = [];
  parentId: string;
  ...
  constructor(
    ...
    super(dataUtils, termTypeService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'termTypeListModification';
  }

  protected initialState(): any {
    return { item: new TermType(), tasks: [], id: undefined };
  }
