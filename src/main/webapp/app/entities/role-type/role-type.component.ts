...
export class RoleTypeComponent extends AbstractEntityComponent<IRoleType> {
  constructor(
  ...
  trackId(index: number, item: IRoleType) {
    return item.id;
  }
  ...
  set roleTypes(roleType: IRoleType[]) {
    this.items = roleType;
  }
}
