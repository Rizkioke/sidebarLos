...
export class ApplicationTypeUpdateComponent extends AbstractEntityUpdateComponent<IApplicationType> {
  ...
  constructor(
    ...
    super(dataUtils, applicationTypeService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'applicationTypeListModification';
  }

  protected initialState(): any {
    return { item: new ApplicationType(), tasks: [], id: undefined };
  }
