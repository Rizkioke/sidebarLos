...
@Component({
  selector: 'jhi-payment-method-type',
  templateUrl: './payment-method-type.component.html',
})
export class PaymentMethodTypeComponent extends AbstractEntityComponent<IPaymentMethodType> {
  constructor(
    ...
    this.parentRoute = '/payment-method-type';
  ...
  trackId(index: number, item: IPaymentMethodType) {
    return item.id;
  }
  ...
  set paymentMethodTypes(paymentMethodType: IPaymentMethodType[]) {
    this.items = paymentMethodType;
  }
}
