...
@Component({
  selector: 'jhi-settlement-type',
  templateUrl: './settlement-type.component.html',
})
export class SettlementTypeComponent extends AbstractEntityComponent<ISettlementType> {
  constructor(
    ...
    this.parentRoute = '/settlement-type';
  ...
  trackId(index: number, item: ISettlementType) {
    return item.id;
  }
  ...
  set settlementTypes(settlementType: ISettlementType[]) {
    this.items = settlementType;
  }
}
