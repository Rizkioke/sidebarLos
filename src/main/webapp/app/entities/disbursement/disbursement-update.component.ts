...
export class DisbursementUpdateComponent extends AbstractEntityUpdateComponent<IDisbursement> {
  ...
  constructor(
    ...
    super(dataUtils, disbursementService, elementRef, confirmationService, toastService, activatedRoute);
    this.useTask = true;
    this.listChangeEventName = 'disbursementListModification';
  }

  protected initialState(): any {
    return { item: new Disbursement(), tasks: [], id: undefined };
  }
  ...
  print() {
    this.reportUtils.viewFile('/api/report/Disbursement/pdf', {});
    return false;
  }
}
