...
@Component({
  selector: 'jhi-personal-customer',
  templateUrl: './personal-customer.component.html',
})
export class PersonalCustomerComponent extends AbstractEntityComponent<IPersonalCustomer> {
  constructor(
    ...
    this.parentRoute = '/personal-customer';
  ...
  trackId(index: number, item: IPersonalCustomer) {
    return item.id;
  }
  ...
  set personalCustomers(personalCustomer: IPersonalCustomer[]) {
    this.items = personalCustomer;
  }
}
