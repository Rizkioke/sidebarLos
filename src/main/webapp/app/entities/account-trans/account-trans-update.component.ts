...
@Component({
  selector: 'jhi-account-trans-update',
  templateUrl: './account-trans-update.component.html',
})
export class AccountTransUpdateComponent extends AbstractEntityUpdateComponent<IAccountTrans> {
  ...
  constructor(
    ...
    super(dataUtils, accountTransService, elementRef, confirmationService, toastService, activatedRoute);
    this.useTask = true;
    this.listChangeEventName = 'accountTransListModification';
  }

  protected initialState(): any {
    return { item: new AccountTrans(), tasks: [], id: undefined };
  }
