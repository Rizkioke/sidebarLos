...
export class FacilityTypeUpdateComponent extends AbstractEntityUpdateComponent<IFacilityType> {
  ...
  constructor(
    ...
    super(dataUtils, facilityTypeService, elementRef, confirmationService, toastService, activatedRoute);
    this.listChangeEventName = 'facilityTypeListModification';
  }

  protected initialState(): any {
    return { item: new FacilityType(), tasks: [], id: undefined };
  }
