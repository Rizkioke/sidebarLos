...
@Component({
  selector: 'jhi-gl-account-type',
  templateUrl: './gl-account-type.component.html',
})
export class GLAccountTypeComponent extends AbstractEntityComponent<IGLAccountType> {
  constructor(
    ...
    this.parentRoute = '/gl-account-type';
  ...
  trackId(index: number, item: IGLAccountType) {
    return item.id;
  }
  ...
  set gLAccountTypes(gLAccountType: IGLAccountType[]) {
    this.items = gLAccountType;
  }
}
