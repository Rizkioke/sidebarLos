...
@Component({
  selector: 'jhi-role-internal',
  templateUrl: './role-internal.component.html',
})
export class RoleInternalComponent extends AbstractEntityComponent<IRoleInternal> {
  ...
  constructor(
    ...
    this.parentRoute = '/role-internal';
  ...
  trackId(index: number, item: IRoleInternal) {
    return item.id;
  }
  ...
  set roleInternals(roleInternal: IRoleInternal[]) {
    this.items = roleInternal;
  }
