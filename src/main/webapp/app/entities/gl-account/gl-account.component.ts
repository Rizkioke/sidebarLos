...
export class GLAccountComponent extends AbstractEntityComponent<IGLAccount> {
  ...
  trackId(index: number, item: IGLAccount) {
    return item.id;
  }
  ...
  set gLAccounts(gLAccount: IGLAccount[]) {
    this.items = gLAccount;
  }
